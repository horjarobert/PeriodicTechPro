...
{
    public partial class kojoS105 : Form
    {
        public kojoS105()
        {
            InitializeComponent();
        ...
        private void kojoS105_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Kojo_(learning_environment)");
        }
