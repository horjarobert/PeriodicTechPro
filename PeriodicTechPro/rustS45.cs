...
{
    public partial class rustS45 : Form
    {
        public rustS45()
        {
            InitializeComponent();
        ...
        private void rustS45_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Rust_(programming_language)");
        }
