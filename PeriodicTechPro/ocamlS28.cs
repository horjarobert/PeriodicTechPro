...
{
    public partial class ocamlS28 : Form
    {
        public ocamlS28()
        {
            InitializeComponent();
        ...
        private void ocamlS28_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/OCaml");
        }
