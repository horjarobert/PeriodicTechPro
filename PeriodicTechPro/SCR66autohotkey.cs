...
{
    public partial class SCR66autohotkey : Form
    {
        public SCR66autohotkey()
        {
            InitializeComponent();
        }

        private void SCR66autohotkey_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/AutoHotkey");
        }
