...
{
    public partial class couchdbQ96 : Form
    {
        public couchdbQ96()
        {
            InitializeComponent();
        ...
        private void couchdbQ96_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Apache_CouchDB");
        }
