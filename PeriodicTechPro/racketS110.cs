...
{
    public partial class racketS110 : Form
    {
        public racketS110()
        {
            InitializeComponent();
        ...
        private void racketS110_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Racket_(programming_language)");
        }
