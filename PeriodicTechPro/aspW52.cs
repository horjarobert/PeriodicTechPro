...
{
    public partial class aspW52 : Form
    {
        public aspW52()
        {
            InitializeComponent();
        ...
        private void aspW52_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/ASP.NET");
        }
