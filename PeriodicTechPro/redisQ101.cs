...
{
    public partial class redisQ101 : Form
    {
        public redisQ101()
        {
            InitializeComponent();
        ...
        private void redisQ101_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Redis");
        }
