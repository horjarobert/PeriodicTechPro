...
{
    public partial class SCR59vbs : Form
    {
        public SCR59vbs()
        {
            InitializeComponent();
        ...
        private void SCR59vbs_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/VBScript");
        }
