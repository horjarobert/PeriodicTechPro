...
{
    public partial class postgreQ91 : Form
    {
        public postgreQ91()
        {
            InitializeComponent();
        ...
        private void postgreQ91_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/PostgreSQL");
        }
