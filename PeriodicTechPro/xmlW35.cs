...
{
    public partial class xmlW35 : Form
    {
        public xmlW35()
        {
            InitializeComponent();
        ...
        private void xmlW35_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/XML");
        }
        ...
        private void abstraction_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.abstraction, "Scale: 1 to 10 => 5");
        }
        ...
        private void simplicity_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.simplicity, "Scale: 1 to 10 => 8");
