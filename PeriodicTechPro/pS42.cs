...
{
    public partial class pS42 : Form
    {
        public pS42()
        {
            InitializeComponent();
        ...
        private void pS42_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/P_(programming_language)");
        }
