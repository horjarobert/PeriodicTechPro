...
{
    public partial class wolframS117 : Form
    {
        public wolframS117()
        {
            InitializeComponent();
        ...
        private void wolframS117_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Wolfram_Language");
        }
