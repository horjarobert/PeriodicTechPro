...
{
    public partial class SCR69ecmascript : Form
    {
        public SCR69ecmascript()
        {
            InitializeComponent();
        }

        private void SCR69ecmascript_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/ECMAScript");
        }
