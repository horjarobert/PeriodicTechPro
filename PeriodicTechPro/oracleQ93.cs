...
{
    public partial class oracleQ93 : Form
    {
        public oracleQ93()
        {
            InitializeComponent();
        ...
        private void oracleQ93_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Oracle_Database");
        }
