...
{
    public partial class swiftS19 : Form
    {
        public swiftS19()
        {
            InitializeComponent();
        ...
        private void swiftS19_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Swift_(programming_language)");
        }
        ...
        private void number_MouseHover(object sender, EventArgs e)
        {
            ...
            eskee.SetToolTip(this.number, "RELEVEANT");
        }
