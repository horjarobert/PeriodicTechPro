...
{
    public partial class oberonS83 : Form
    {
        public oberonS83()
        {
            InitializeComponent();
        ...
        private void oberonS83_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Oberon_(programming_language)");
        }
