...
{
    public partial class elixirS23 : Form
    {
        public elixirS23()
        {
            InitializeComponent();
        ...
        private void elixirS23_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Elixir_(programming_language)");
        }
        ...
        private void simplicity_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.simplicity, "Scale: 1 to 10 => 5");
        }
    }
}
