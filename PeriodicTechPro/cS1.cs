...
namespace PeriodicTechPro
{
    public partial class cS1 : Form
    {
        ...
        private void cS1_Load(object sender, EventArgs e)
        {
        ...
        private void symbol_MouseHover(object sender, EventArgs e)
        {
            ...
            symex.SetToolTip(this.symbol, "Symbol and also filename extension");  
        }
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/C_(programming_language)");
        }
    }
}
