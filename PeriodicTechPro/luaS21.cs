...
{
    public partial class luaS21 : Form
    {
        public luaS21()
        {
            InitializeComponent();
        ...
        private void luaS21_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Lua_(programming_language)"); 
        }
