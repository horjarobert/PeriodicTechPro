...
{
    public partial class htmlW5 : Form
    {
        public htmlW5()
        {
            InitializeComponent();
        ...
        private void htmlW5_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/HTML");
        }
        ...
        private void abstraction_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.abstraction, "Scale: 1 to 10 => 3");
        }
        ...
        private void simplicity_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.simplicity, "Scale: 1 to 10 => 10");
        }
    }
}
