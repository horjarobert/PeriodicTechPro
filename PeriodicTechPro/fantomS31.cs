...
{
    public partial class fantomS31 : Form
    {
        public fantomS31()
        {
            InitializeComponent();
        ...
        private void fantomS31_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Fantom_(programming_language)");
        }
