...
{
    public partial class SCR71maxscript : Form
    {
        public SCR71maxscript()
        {
            InitializeComponent();
        }

        private void SCR71maxscript_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Autodesk_3ds_Max");
        }
        ...
        private void year_MouseHover(object sender, EventArgs e)
        {
            ...
            yearB.SetToolTip(this.year, "year of birth [not sure:D]");
