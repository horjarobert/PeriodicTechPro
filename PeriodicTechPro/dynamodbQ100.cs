...
{
    public partial class dynamodbQ100 : Form
    {
        public dynamodbQ100()
        {
            InitializeComponent();
        ...
        private void dynamodbQ100_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Amazon_DynamoDB");
        }
