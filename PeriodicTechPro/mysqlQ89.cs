...
{
    public partial class mysqlQ89 : Form
    {
        public mysqlQ89()
        {
            InitializeComponent();
        ...
        private void mysqlQ89_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/MySQL");
        }
        ...
        private void simplicity_MouseLeave(object sender, EventArgs e)
        {
