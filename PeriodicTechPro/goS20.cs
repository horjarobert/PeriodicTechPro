...
{
    public partial class goS20 : Form
    {
        public goS20()
        {
            InitializeComponent();
        ...
        private void goS20_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Go_(programming_language)");
        }
