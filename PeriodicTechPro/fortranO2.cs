...
{
    public partial class fortranO2 : Form
    {
        public fortranO2()
        {
            InitializeComponent();
        ...
        private void fortranO2_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Fortran");
        }
