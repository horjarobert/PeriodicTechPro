...
{
    public partial class booS50 : Form
    {
        public booS50()
        {
            InitializeComponent();
        ...
        private void booS50_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Boo_(programming_language)");
        }
