...
{
    public partial class openclS79 : Form
    {
        public openclS79()
        {
            InitializeComponent();
        ...
        private void openclS79_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/OpenCL");
        }
        ...
        private void year_MouseHover(object sender, EventArgs e)
        {
            ...
            yearB.SetToolTip(this.year, "year of birth [not sure]");
        }
