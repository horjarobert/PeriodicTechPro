...
{
    public partial class rebolS80 : Form
    {
        public rebolS80()
        {
            InitializeComponent();
        ...
        private void rebolS80_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Rebol");
        }
