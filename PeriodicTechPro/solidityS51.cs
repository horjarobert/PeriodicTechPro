...
{
    public partial class solidityS51 : Form
    {
        public solidityS51()
        {
            InitializeComponent();
        ...
        private void solidityS51_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Solidity");
        }
