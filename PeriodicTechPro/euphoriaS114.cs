...
{
    public partial class euphoriaS114 : Form
    {
        public euphoriaS114()
        {
            InitializeComponent();
        ...
        private void euphoriaS114_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Euphoria_(programming_language)");
        }
