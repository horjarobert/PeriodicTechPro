...
{
    public partial class pascalO86 : Form
    {
        public pascalO86()
        {
            InitializeComponent();
        ...
        private void pascalO86_Load(object sender, EventArgs e)
        {
            animation.AnimateWindow(this.Handle, 500, animation.CENTER);
        }

        private void pascalO86_Load_1(object sender, EventArgs e)
        {
            animation.AnimateWindow(this.Handle, 500, animation.CENTER);
        }
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Pascal_(programming_language)");
        }
        ...
        private void label8_MouseHover(object sender, EventArgs e)
        {
            ...
            goOnline.SetToolTip(this.label8, "Click and learn!");
        }
        ...
        private void label7_MouseHover(object sender, EventArgs e)
        {
            ...
            symex.SetToolTip(this.label7, "Symbol and a filename extension");
        }
        ...
        private void number_MouseHover(object sender, EventArgs e)
        {
            ...
            eskee.SetToolTip(this.number, "RAW");
