...
{
    public partial class aliceS75 : Form
    {
        public aliceS75()
        {
            InitializeComponent();
        ...
        private void aliceS75_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Alice_(programming_language)");
        }
