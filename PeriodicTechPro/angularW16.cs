...
{
    public partial class angularW16 : Form
    {
        public angularW16()
        {
            InitializeComponent();
        ...
        private void angularW16_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/AngularJS");
        }
