...
{
    public partial class linqQ95 : Form
    {
        public linqQ95()
        {
            InitializeComponent();
        ...
        private void linqQ95_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Language_Integrated_Query");
        }
