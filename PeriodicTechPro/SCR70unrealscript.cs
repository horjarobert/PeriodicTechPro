...
{
    public partial class SCR70unrealscript : Form
    {
        public SCR70unrealscript()
        {
            InitializeComponent();
        }

        private void SCR70unrealscript_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Unreal_Engine");
        }
