...
{
    public partial class SCR61scheme : Form
    {
        public SCR61scheme()
        {
            InitializeComponent();
        ...
        private void SCR61scheme_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Scheme_(programming_language)");
        }
