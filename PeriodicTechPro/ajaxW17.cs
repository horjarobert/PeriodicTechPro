...
{
    public partial class ajaxW17 : Form
    {
        public ajaxW17()
        {
            InitializeComponent();
        ...
        private void ajaxW17_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Ajax_(programming)");
        }
