...
{
    public partial class assemblyS13 : Form
    {
        public assemblyS13()
        {
            InitializeComponent();
        ...
        private void assemblyS13_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Assembly_language");
        }
