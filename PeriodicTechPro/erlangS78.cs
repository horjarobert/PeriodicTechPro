...
{
    public partial class erlangS78 : Form
    {
        public erlangS78()
        {
            InitializeComponent();
        ...
        private void erlangS78_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Erlang_(programming_language)");
        }
        ...
        private void efficiency_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.efficiency, "Scale: 1 to 10 => 6");
        }
