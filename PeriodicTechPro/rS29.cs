...
{
    public partial class rS29 : Form
    {
        public rS29()
        {
            InitializeComponent();
        ...
        private void rS29_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/R_(programming_language)");
        }
