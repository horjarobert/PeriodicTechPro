...
{
    public partial class pythonW85 : Form
    {
        public pythonW85()
        {
            InitializeComponent();
        ...
        private void pythonW85_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Python_(programming_language)");
        }
