...
{
    public partial class SCR68rexx : Form
    {
        public SCR68rexx()
        {
            InitializeComponent();
        ...
        private void SCR68rexx_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Rexx");
        }
