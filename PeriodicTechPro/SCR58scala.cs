...
{
    public partial class SCR58scala : Form
    {
        public SCR58scala()
        {
            InitializeComponent();
        ...
        private void SCR58scala_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Scala_(programming_language)");
        }
