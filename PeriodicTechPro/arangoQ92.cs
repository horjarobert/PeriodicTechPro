...
{
    public partial class arangoQ92 : Form
    {
        public arangoQ92()
        {
            InitializeComponent();
        ...
        private void arangoQ92_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/ArangoDB");
        }
