...
{
    public partial class rubyW14 : Form
    {
        public rubyW14()
        {
            InitializeComponent();
        ...
        private void rubyW14_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Ruby_(programming_language)");
        }
