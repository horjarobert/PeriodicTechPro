...
{
    public partial class SCR67postscript : Form
    {
        public SCR67postscript()
        {
            InitializeComponent();
        }

        private void SCR67postscript_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/PostScript");
        }
