...
{
    public partial class nekoS109 : Form
    {
        public nekoS109()
        {
            InitializeComponent();
        ...
        private void nekoS109_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/NekoVM");
        }
