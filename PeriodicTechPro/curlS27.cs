...
{
    public partial class curlS27 : Form
    {
        public curlS27()
        {
            InitializeComponent();
        ...
        private void curlS27_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Curl_(programming_language)");
        }
