...
{
    public partial class mongoQ90 : Form
    {
        public mongoQ90()
        {
            InitializeComponent();
        ...
        private void mongoQ90_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/MongoDB");
        }
