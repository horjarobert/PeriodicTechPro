...
{
    public partial class dartS26 : Form
    {
        public dartS26()
        {
            InitializeComponent();
        ...
        private void dartS26_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Dart_(programming_language)");
        }
