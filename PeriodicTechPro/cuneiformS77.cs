...
{
    public partial class cuneiformS77 : Form
    {
        public cuneiformS77()
        {
            InitializeComponent();
        ...
        private void cuneiformS77_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Cuneiform_(programming_language)");
        }
        ...
        private void abstraction_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.abstraction, "Scale: 1 to 10 => 9");
        }
