...
{
    public partial class objectiveS37 : Form
    {
        public objectiveS37()
        {
            InitializeComponent();
        ...
        private void objectiveS37_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Objective-C");
        }

        private void symbol_MouseHover(object sender, EventArgs e)
        {
            ToolTip symex = new ToolTip();
            symex.SetToolTip(this.symbol, "Symbol name and also a filename extension");
        }
