...
{
    public partial class arcS104 : Form
    {
        public arcS104()
        {
            InitializeComponent();
        ...
        private void arcS104_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Arc_(programming_language)");
        }
