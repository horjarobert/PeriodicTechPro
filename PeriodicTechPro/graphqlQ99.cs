...
{
    public partial class graphqlQ99 : Form
    {
        public graphqlQ99()
        {
            InitializeComponent();
        ...
        private void graphqlQ99_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/GraphQL");
        }
