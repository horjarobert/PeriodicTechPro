...
{
    public partial class gosuS46 : Form
    {
        public gosuS46()
        {
            InitializeComponent();
        ...
        private void gosuS46_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Gosu_(programming_language)");
        }
