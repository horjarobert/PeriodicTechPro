...
{
    public partial class zonnonS113 : Form
    {
        public zonnonS113()
        {
            InitializeComponent();
        ...
        private void zonnonS113_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Zonnon");
        }
