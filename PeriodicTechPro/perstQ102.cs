...
{
    public partial class perstQ102 : Form
    {
        public perstQ102()
        {
            InitializeComponent();
        ...
        private void perstQ102_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Perst");
        }
