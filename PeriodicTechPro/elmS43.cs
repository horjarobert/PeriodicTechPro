...
{
    public partial class elmS43 : Form
    {
        public elmS43()
        {
            InitializeComponent();
        ...
        private void elmS43_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Elm_(programming_language)");
        }
