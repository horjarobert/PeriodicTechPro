...
{
    public partial class citrineS72 : Form
    {
        public citrineS72()
        {
            InitializeComponent();
        ...
        private void citrineS72_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Citrine_(programming_language)");
        }
