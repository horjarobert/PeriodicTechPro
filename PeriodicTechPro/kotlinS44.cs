...
{
    public partial class kotlinS44 : Form
    {
        public kotlinS44()
        {
            InitializeComponent();
        ...
        private void kotlinS44_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Kotlin_(programming_language)");
        }
