...
{
    public partial class SCR64autoit : Form
    {
        public SCR64autoit()
        {
            InitializeComponent();
        ...
        private void SCR64autoit_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/AutoIt");
        }
