...
{
    public partial class javaS11 : Form
    {
        public javaS11()
        {
            InitializeComponent();
        ...
        private void javaS11_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Java_(programming_language)");
        }
    }
}
