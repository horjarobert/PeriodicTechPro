...
{
    public partial class bashS82 : Form
    {
        public bashS82()
        {
            InitializeComponent();
        ...
        private void bashS82_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Bash_(Unix_shell)");
        }
