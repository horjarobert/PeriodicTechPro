...
{
    public partial class nimS41 : Form
    {
        public nimS41()
        {
            InitializeComponent();
        ...
        private void nimS41_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Nim_(programming_language)");
        }
