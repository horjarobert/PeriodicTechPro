...
{
    public partial class groovyS32 : Form
    {
        public groovyS32()
        {
            InitializeComponent();
        ...
        private void groovyS32_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Apache_Groovy");
        }
