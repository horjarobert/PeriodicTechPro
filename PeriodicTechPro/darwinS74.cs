...
{
    public partial class darwinS74 : Form
    {
        public darwinS74()
        {
            InitializeComponent();
        ...
        private void darwinS74_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Darwin_(programming_language)");
        }
