...
{
    public partial class prologS118 : Form
    {
        public prologS118()
        {
            InitializeComponent();
        ...
        private void prologS118_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Prolog");
        }
