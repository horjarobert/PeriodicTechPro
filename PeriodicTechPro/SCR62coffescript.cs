...
{
    public partial class SCR62coffescript : Form
    {
        public SCR62coffescript()
        {
            InitializeComponent();
        }

        private void SCR62coffescript_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/CoffeeScript");
        }
