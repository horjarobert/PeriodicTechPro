...
{
    public partial class SCR60powershell : Form
    {
        public SCR60powershell()
        {
            InitializeComponent();
        }

        private void SCR60powershell_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/PowerShell");
        }
