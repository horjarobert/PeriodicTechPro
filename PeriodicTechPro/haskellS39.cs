...
{
    public partial class haskellS39 : Form
    {
        public haskellS39()
        {
            InitializeComponent();
        ...
        private void haskellS39_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Haskell_(programming_language)");
        }
