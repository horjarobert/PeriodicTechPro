...
{
    public partial class yorickS111 : Form
    {
        public yorickS111()
        {
            InitializeComponent();
        ...
        private void yorickS111_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Yorick_(programming_language)");
        }
