...
{
    public partial class idlS87 : Form
    {
        public idlS87()
        {
            InitializeComponent();
        ...
        private void idlS87_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/IDL_(programming_language)");
        }
