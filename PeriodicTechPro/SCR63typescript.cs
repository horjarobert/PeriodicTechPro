...
{
    public partial class SCR63typescript : Form
    {
        public SCR63typescript()
        {
            InitializeComponent();
        }

        private void SCR63typescript_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/TypeScript");
        }
