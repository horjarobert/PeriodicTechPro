...
{
    public partial class matlabS38 : Form
    {
        public matlabS38()
        {
            InitializeComponent();
        ...
        private void matlabS38_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/MATLAB");
        }
        ...
        private void year_MouseHover(object sender, EventArgs e)
        {
            ...
            yearB.SetToolTip(this.year, "year of birth (late 1970s)");
        }
