...
{
    public partial class basicS108 : Form
    {
        public basicS108()
        {
            InitializeComponent();
        ...
        private void basicS108_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/BASIC");
        }
