...
{
    public partial class jsharpS22 : Form
    {
        public jsharpS22()
        {
            InitializeComponent();
        ...
        private void jsharpS22_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/J_Sharp");
        }
