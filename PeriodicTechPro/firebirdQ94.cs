...
{
    public partial class firebirdQ94 : Form
    {
        public firebirdQ94()
        {
            InitializeComponent();
        ...
        private void firebirdQ94_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Firebird_(database_server)");
        }
