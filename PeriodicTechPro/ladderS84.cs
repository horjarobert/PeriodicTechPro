...
{
    public partial class ladderS84 : Form
    {
        public ladderS84()
        {
            InitializeComponent();
        ...
        private void ladderS84_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Ladder_logic");
        }
        ...
        private void year_MouseHover(object sender, EventArgs e)
        {
            ...
            yearB.SetToolTip(this.year, "year of birth (not 100% sure)");
        }
