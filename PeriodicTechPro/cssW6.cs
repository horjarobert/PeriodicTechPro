...
{
    public partial class cssW6 : Form
    {
        public cssW6()
        {
            InitializeComponent();
        ...
        private void cssW6_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Cascading_Style_Sheets");
        }
