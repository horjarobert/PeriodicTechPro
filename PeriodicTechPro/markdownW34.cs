...
{
    public partial class markdownW34 : Form
    {
        public markdownW34()
        {
            InitializeComponent();
        ...
        private void markdownW34_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Markdown");
        }
        ...
        private void abstraction_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.abstraction, "Scale: 1 to 10 => 4");
        }
        ...
        private void efficiency_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.efficiency, "Scale: 1 to 10 => 9");
        }
        ...
        private void simplicity_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.simplicity, "Scale: 1 to 10 => 9");
        }
    }
}
