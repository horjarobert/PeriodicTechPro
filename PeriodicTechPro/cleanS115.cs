...
{
    public partial class cleanS115 : Form
    {
        public cleanS115()
        {
            InitializeComponent();
        ...
        private void cleanS115_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Clean_(programming_language)");
        }
