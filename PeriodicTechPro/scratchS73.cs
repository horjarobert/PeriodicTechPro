...
{
    public partial class scratchS73 : Form
    {
        public scratchS73()
        {
            InitializeComponent();
        ...
        private void scratchS73_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Scratch_(programming_language)");
        }
