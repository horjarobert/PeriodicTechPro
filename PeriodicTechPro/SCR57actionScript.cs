...
{
    public partial class SCR57actionScript : Form
    {
        public SCR57actionScript()
        {
            InitializeComponent();
        }

        private void SCR57actionScript_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/ActionScript");
        }
        ...
        private void symbol_MouseHover(object sender, EventArgs e)
        {
            ...
            symex.SetToolTip(this.symbol, "Symbol and filename extension");
        }
        ...
        private void number_MouseHover(object sender, EventArgs e)
        {
            ...
            eskee.SetToolTip(this.number, "MIDDLE");
        }
        ...
        private void abstraction_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.abstraction, "Scale: 1 to 10 => 8");
        }
        ...
        private void efficiency_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.efficiency, "Scale: 1 to 10 => 7");
        }
        ...
        private void simplicity_MouseHover(object sender, EventArgs e)
        {
            ...
            infos.SetToolTip(this.simplicity, "Scale: 1 to 10 => 6");
        }

        private void symbol_MouseEnter(object sender, EventArgs e)
        {
