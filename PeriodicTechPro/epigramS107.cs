...
{
    public partial class epigramS107 : Form
    {
        public epigramS107()
        {
            InitializeComponent();
        ...
        private void epigramS107_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Epigram_(programming_language)");
        }
