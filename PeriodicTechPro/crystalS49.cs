...
{
    public partial class crystalS49 : Form
    {
        public crystalS49()
        {
            InitializeComponent();
        ...
        private void crystalS49_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Crystal_(programming_language)");
        }
