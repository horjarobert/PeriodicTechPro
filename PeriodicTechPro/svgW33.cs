...
{
    public partial class svgW33 : Form
    {
        public svgW33()
        {
            InitializeComponent();
        ...
        private void svgW33_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Scalable_Vector_Graphics");
        }
