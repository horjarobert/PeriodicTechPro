...
{
    public partial class cassandraQ103 : Form
    {
        public cassandraQ103()
        {
            InitializeComponent();
        }

        private void cassandraQ103_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Apache_Cassandra");
        }
