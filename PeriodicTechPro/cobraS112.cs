...
{
    public partial class cobraS112 : Form
    {
        public cobraS112()
        {
            InitializeComponent();
        ...
        private void cobraS112_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Cobra_(programming_language)");
        }
