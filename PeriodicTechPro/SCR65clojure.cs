...
{
    public partial class SCR65clojure : Form
    {
        public SCR65clojure()
        {
            InitializeComponent();
        ...
        private void SCR65clojure_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Clojure");
        }
