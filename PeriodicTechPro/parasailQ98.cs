...
{
    public partial class parasailQ98 : Form
    {
        public parasailQ98()
        {
            InitializeComponent();
        ...
        private void parasailQ98_Load(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/ParaSail_(programming_language)");
        }
